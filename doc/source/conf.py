...
sys.path.insert(0, os.path.abspath('../flaat/'))
sys.path.insert(0, os.path.abspath('../../flaat/'))
sys.path.insert(0, os.path.abspath('../../../flaat/'))
...
html_theme_options = {
    ...
    'show_related': False,
    'note_bg': '#FFF59C',
    'description': 'FLAsk support for oidc Access Tokens - FLAAT',
}
...
# [howto/manual]).
latex_documents = [
    ('index', 'flaat.tex', u'FLAAT Documentation',
     author, 'manual'),
]
